...
config.processCcd.isr.retarget(target=lsst.obs.cfht.cfhtIsrTask.CfhtIsrTask, ConfigClass=lsst.obs.cfht.cfhtIsrTask.CfhtIsrTaskConfig)
...
config.processCcd.isr.overscanFitType='MEDIAN'
...
config.processCcd.isr.overscanOrder=1
...
config.processCcd.isr.overscanBiasJumpDevices=[]

# Location of bias jump along y-axis.
config.processCcd.isr.overscanBiasJumpLocation=0
...
config.processCcd.isr.doAssembleIsrExposures=True
...
config.processCcd.isr.crosstalk.crosstalkBackgroundMethod='None'

# Ignore the detector crosstalk information in favor of CrosstalkConfig values?
config.processCcd.isr.crosstalk.useConfigCoefficients=False
...
config.processCcd.isr.crosstalk.crosstalkValues=[0.0]

# Shape of the coefficient array.  This should be equal to [nAmp, nAmp].
config.processCcd.isr.crosstalk.crosstalkShape=[1]
...
config.processCcd.isr.brighterFatterMaskGrowSize=0
...
# 
config.processCcd.isr.strayLight.doRotatorAngleCorrection=False

# Filters that need straylight correction.
config.processCcd.isr.strayLight.filters=[]
...
config.processCcd.isr.fringe.stats.badMaskPlanes=['SAT']
...
config.processCcd.isr.fringe.pedestal=True

# Do fringe subtraction after flat-fielding?
config.processCcd.isr.fringeAfterFlat=False

# Measure the background level on the reduced image?
config.processCcd.isr.doMeasureBackground=False
...
config.processCcd.isr.vignette.doWriteVignettePolygon=False
...
config.processCcd.isr.safe=0.95
...
config.processCcd.charImage.measurement.plugins.names=['base_SdssShape', 'base_PixelFlags', 'base_CircularApertureFlux', 'base_PsfFlux', 'base_GaussianFlux', 'base_SdssCentroid']
# whether to run this plugin in single-object mode
...
config.processCcd.charImage.refObjLoader.filterMap={'i2': 'i'}
...
# Mapping of camera filter name: reference catalog filter name; each reference filter must exist
config.processCcd.calibrate.astromRefObjLoader.filterMap={'i2': 'i'}
...
# Mapping of camera filter name: reference catalog filter name; each reference filter must exist
config.processCcd.calibrate.photoRefObjLoader.filterMap={'i2': 'i'}
...
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['u']=lsst.pipe.tasks.colorterms.Colorterm()
# name of primary filter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['u'].primary='u'

# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['u'].secondary='g'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['u'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['u'].c1=-0.241

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['u'].c2=0.0
...
# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['g'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['g'].c1=-0.153

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['g'].c2=0.0
...
# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['r'].secondary='g'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['r'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['r'].c1=0.024

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['r'].c2=0.0
...
# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['i'].secondary='r'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['i'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['i'].c1=0.085

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['i'].c2=0.0
...
# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['z'].secondary='i'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['z'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['z'].c1=-0.074

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['ps1*'].data['z'].c2=0.0

config.processCcd.calibrate.photoCal.colorterms.data['e2v']=lsst.pipe.tasks.colorterms.ColortermDict()
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data={}
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['u']=lsst.pipe.tasks.colorterms.Colorterm()
# name of primary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['u'].primary='u'

# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['u'].secondary='g'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['u'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['u'].c1=-0.241

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['u'].c2=0.0

config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['g']=lsst.pipe.tasks.colorterms.Colorterm()
# name of primary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['g'].primary='g'

# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['g'].secondary='r'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['g'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['g'].c1=-0.153

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['g'].c2=0.0

config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['r']=lsst.pipe.tasks.colorterms.Colorterm()
# name of primary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['r'].primary='r'

# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['r'].secondary='g'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['r'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['r'].c1=0.024

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['r'].c2=0.0

config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['i']=lsst.pipe.tasks.colorterms.Colorterm()
# name of primary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['i'].primary='i'

# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['i'].secondary='r'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['i'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['i'].c1=0.085

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['i'].c2=0.0

config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['z']=lsst.pipe.tasks.colorterms.Colorterm()
# name of primary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['z'].primary='z'

# name of secondary filter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['z'].secondary='i'

# Constant parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['z'].c0=0.0

# First-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['z'].c1=-0.074

# Second-order parameter
config.processCcd.calibrate.photoCal.colorterms.data['e2v'].data['z'].c2=0.0
...
config.processCcd.calibrate.measurement.plugins.names=['base_LocalBackground', 'base_Variance', 'base_NaiveCentroid', 'base_Blendedness', 'base_SdssShape', 'base_LocalPhotoCalib', 'modelfit_CModel', 'base_PixelFlags', 'base_LocalWcs', 'modelfit_DoubleShapeletPsfApprox', 'base_GaussianFlux', 'base_SdssCentroid', 'base_CircularApertureFlux', 'base_SkyCoord', 'base_PsfFlux']
# whether to run this plugin in single-object mode
